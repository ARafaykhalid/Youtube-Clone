...
import { Search, Menu, Mic, Video, Bell, User, Settings } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between h-14 px-4 bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-800">
        ...
        <Link to="/" className="flex items-center">
          ...
          >
            ...
            <g>
              ...
              ></path>
              <path 
                d="M56.8154 18.5634H54.6094L54.3648 17.03H54.3037C53.7039 18.1871 52.8055 18.7656 51.6061 18.7656C50.7759 18.7656 50.1621 18.4928 49.767 17.9496C49.3719 17.4039 49.1743 16.5526 49.1743 15.3955V6.03751H51.9942V15.2308C51.9942 15.7906 52.0553 16.188 52.1776 16.4256C52.2999 16.6631 52.5045 16.783 52.7914 16.783C53.036 16.783 53.2712 16.7078 53.497 16.5573C53.7228 16.4068 53.8874 16.2162 53.9979 15.9858V6.03516H56.8154V18.5634Z" 
                fill="currentColor"
                className="dark:fill-white"
              ></path>
              <path 
        ...
        >
          <div className="relative flex-grow">
            <input
              ...
              placeholder="Search"
              className="w-full py-2 pl-4 pr-10 border border-gray-300 rounded-l-full focus:outline-none focus:border-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:placeholder-gray-400"
            />
          </div>
          <button 
            type="submit" 
            className="bg-gray-100 hover:bg-gray-200 py-2 px-6 rounded-r-full border border-l-0 border-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-700"
          >
