...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-14 bg-background z-50 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4">
      ...
      <div ref={searchRef} className="hidden md:flex relative items-center flex-1 mx-6 max-w-xl">
