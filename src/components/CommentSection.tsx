        ...
        <form onSubmit={handleSubmitComment} className="flex-grow">
          ...
          <div className="flex justify-end mt-2 space-x-2">
            ...
            <button 
              ...
              className="px-3 py-1 text-sm font-medium rounded-full bg-blue-50 text-blue-700 hover:bg-blue-100 dark:bg-blue-900 dark:text-blue-200 dark:hover:bg-blue-800 disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:bg-gray-800 dark:disabled:text-gray-400"
            >
              Comment
            </button>
          </div>
