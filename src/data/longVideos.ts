...
export const longVideos: Video[] = [
  {
    ...
    duration: "1:28:24",
    description: "In this comprehensive tutorial, I show you how to build a complete YouTube clone using React and Tailwind CSS. We'll cover responsive design, component architecture, and styling techniques to create a beautiful and functional UI.",
    videoId: "4F2m91eKmJk",
    likes: 12400,
    dislikes: 400,
    category: "education"
  ...
  {
    id: "lv3",
    title: "TypeScript Course for Beginners 2023 - Learn TypeScript from Scratch!",
    thumbnailUrl: "https://i.ytimg.com/vi/BwuLxPH8IDs/maxresdefault.jpg",
    channelName: "Academind",
    channelImageUrl: "https://yt3.googleusercontent.com/ytc/APkrFKZJ-NJzRsUCO5mZE-UEAODzr8EF2wvAQQFNcrZ-Hg=s176-c-k-c0x00ffffff-no-rj",
    views: "875K views",
    timestamp: "2 months ago",
    duration: "3:27:18",
    description: "This TypeScript course teaches you TypeScript from the ground up, answering the question 'What is TypeScript?' and then diving into types, interfaces, classes, and more.",
    videoId: "BwuLxPH8IDs",
    likes: 28500,
    dislikes: 320,
    category: "education"
  ...
  {
    id: "lv4",
    title: "Full Next.js App Router Course — Authentication, Metadata, API Routes, and More",
    thumbnailUrl: "https://i.ytimg.com/vi/6h649f2fB9Q/maxresdefault.jpg",
    ...
    duration: "4:23:52",
    description: "Learn Next.js with this comprehensive course on the App Router. We'll build a full stack application with authentication, metadata, API routes, and more.",
    videoId: "6h649f2fB9Q",
    likes: 15800,
    dislikes: 280,
    category: "education"
  },
  {
    ...
    thumbnailUrl: "https://i.ytimg.com/vi/eWRfhZUzrAc/maxresdefault.jpg",
    channelName: "freeCodeCamp.org",
    channelImageUrl: "https://yt3.googleusercontent.com/ytc/APkrFKaqca-xQcJtp9XfTfYYk2TCk0-aL4CQQ0jGiLGNZw=s176-c-k-c0x00ffffff-no-rj",
    views: "8.2M views",
    timestamp: "2 years ago",
    duration: "4:26:52",
    description: "Learn Python in this full tutorial course for beginners. This course takes a project-based approach to learning Python. You'll build various applications and learn key programming concepts along the way.",
    videoId: "eWRfhZUzrAc",
    likes: 248000,
    dislikes: 3600,
    category: "education"
  ...
  },
  {
    ...
    thumbnailUrl: "https://i.ytimg.com/vi/rufB8IN5-JA/maxresdefault.jpg",
    channelName: "Clément Mihailescu",
    channelImageUrl: "https://yt3.googleusercontent.com/ytc/APkrFKZtv1PxWdlOSQ9TiIq8w4ow-G-_sYwo8f8nB42y8w=s176-c-k-c0x00ffffff-no-rj",
    views: "4.5M views",
    timestamp: "1 year ago",
    duration: "18:25",
    description: "Ever wondered what software engineers do all day? In this video, I take you through my typical workday as a software engineer at a tech company.",
    videoId: "rufB8IN5-JA",
    likes: 132000,
    dislikes: 870,
    category: "tech"
  ...
  },
  {
    ...
    thumbnailUrl: "https://i.ytimg.com/vi/IDDmrX0DYQY/maxresdefault.jpg",
    channelName: "CS50",
    channelImageUrl: "https://yt3.googleusercontent.com/ytc/APkrFKYRZE5QVKZcPGuMvCKFl-UsQVWD-rTkuEbL-9yR=s176-c-k-c0x00ffffff-no-rj",
    views: "820K views",
    timestamp: "8 months ago",
    duration: "2:14:52",
    description: "This is the first lecture from Harvard University's introduction to the intellectual enterprises of computer science and the art of programming.",
    videoId: "IDDmrX0DYQY",
    likes: 37000,
    dislikes: 420,
    category: "education"
  ...
  {
    id: "lv25",
    title: "Ruby on Rails Crash Course 2023",
    thumbnailUrl: "https://i.ytimg.com/vi/ZKaVZQmR6D8/maxresdefault.jpg",
    channelName: "Andy Leverenz",
    channelImageUrl: "https://yt3.googleusercontent.com/ytc/APkrFKagVhNa2fSY2mV85mBU9JCe_cGdzTfMRUYTwHxd=s176-c-k-c0x00ffffff-no-rj",
    views: "280K views",
    timestamp: "5 months ago",
    duration: "2:28:36",
    description: "Learn Ruby on Rails from scratch in this comprehensive crash course. You'll understand MVC architecture, ActiveRecord, routes, and how to build a complete web application with Rails.",
    videoId: "ZKaVZQmR6D8",
    likes: 14700,
    dislikes: 220,
    category: "education"
